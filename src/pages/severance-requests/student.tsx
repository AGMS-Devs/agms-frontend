          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                {Object.entries(studentChecklist).map(
                  ([department, status]) => (
              ...
              <div className="mt-6">
                {Object.values(studentChecklist).every(
                  (status) => status === "Approved"
                ) ? (
                  <p className="text-green-700 font-semibold">
                    🎉 Your clearance is fully approved!
                  </p>
                ) : (
                  <p className="text-yellow-700 font-medium">
                    ⚠️ Some approvals are still pending. Please check back
                    later.
                  </p>
                )}
              </div>
